...
<acme:form> 
	...
	<acme:input-moment code="sponsor.sponsorship.form.label.finish" path="finish"/>
	...
	<jstl:choose>	 
		<jstl:when test="${_command == 'show' && published == true}">
			<acme:button code="sponsor.sponsorship.form.button.invoice" action="/sponsor/invoice/list-service?masterId=${id}"/>			
		</jstl:when>
